(function($) {
	...
	$(document).ready(function () {
		...
		$(document).on("click", "button[id^='ays-chart-filter']", function (e) {
			...
			var inputSelectors = ['#ays-chart-filter-select', '#ays-chart-filter-author', '#ays-chart-filter-source', '#ays-chart-order-by', '#ays-chart-order'];
			var inputValues = inputSelectors.map(selector => parent.find(selector).val());

			var filterFields = ['filterbytype', 'filterbyauthor', 'filterbysource', 'orderby', 'order'];
